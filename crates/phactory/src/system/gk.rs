...
use phala_types::{
    ...
    messaging::{
        BatchRotateMasterKeyEvent, ClusterKeyDistribution, DispatchMasterKeyHistoryEvent,
        EncryptedKey, GatekeeperEvent, KeyDistribution, MessageOrigin, MiningInfoUpdateEvent,
        MiningReportEvent, RandomNumber, RandomNumberEvent, RotateMasterKeyEvent, SettleInfo,
